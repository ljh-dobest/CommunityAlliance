...
public class DealBuyCommentListAdapter$ShareCommentListAdapterViewHolder_ViewBinding implements Unbinder {
  private DealBuyCommentListAdapter.ShareCommentListAdapterViewHolder target;

  @UiThread
  public DealBuyCommentListAdapter$ShareCommentListAdapterViewHolder_ViewBinding(DealBuyCommentListAdapter.ShareCommentListAdapterViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    DealBuyCommentListAdapter.ShareCommentListAdapterViewHolder target = this.target;
