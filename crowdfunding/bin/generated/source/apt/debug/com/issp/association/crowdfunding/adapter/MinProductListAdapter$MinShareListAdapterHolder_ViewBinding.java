...
public class MinProductListAdapter$MinShareListAdapterHolder_ViewBinding implements Unbinder {
  private MinProductListAdapter.MinShareListAdapterHolder target;

  @UiThread
  public MinProductListAdapter$MinShareListAdapterHolder_ViewBinding(MinProductListAdapter.MinShareListAdapterHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MinProductListAdapter.MinShareListAdapterHolder target = this.target;
