...
public class ProductCommentActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public ProductCommentActivity_ViewBinding(ProductCommentActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ProductCommentActivity_ViewBinding(final ProductCommentActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ProductCommentActivity target = this.target;
