...
public class ManagementShippingAddressActivity_ViewBinding implements Unbinder {
  private ManagementShippingAddressActivity target;

  private View view2131624145;

  @UiThread
  public ManagementShippingAddressActivity_ViewBinding(ManagementShippingAddressActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ManagementShippingAddressActivity_ViewBinding(final ManagementShippingAddressActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ManagementShippingAddressActivity target = this.target;
