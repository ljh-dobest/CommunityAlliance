...
public class ProductCommentListAdapter$ShareCommentListAdapterViewHolder_ViewBinding implements Unbinder {
  private ProductCommentListAdapter.ShareCommentListAdapterViewHolder target;

  @UiThread
  public ProductCommentListAdapter$ShareCommentListAdapterViewHolder_ViewBinding(ProductCommentListAdapter.ShareCommentListAdapterViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ProductCommentListAdapter.ShareCommentListAdapterViewHolder target = this.target;
