package com.issp.association.crowdfunding.network;
...
public class HttpUtils {
 ...
 /*   public static void sendGsonPostRequest(String url, Object com.t.baymax.navi.entity, Callback com.t.baymax.navi.callback) {
    ...
    public static void sendFormatPostRequest(String url, Map<String, String> params,
                                              File file, String fileName, StringCallback callback) {
     ...
     */
    public static void sendFormatPostRequest(String url, Map<String, String> params,
                                             Map<String, String> headers, Map<String, File> files, String fileName, StringCallback callback) {
        OkHttpUtils.post()
                .headers(headers)
                .url(URL + url)
                .params(params)
