...
public class HomePageFragment extends Fragment implements AbsListView.OnScrollListener, AdapterView.OnItemClickListener {
   ...
   private void initListView() {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        int curPositon=position;
        switch (position) {
            case 0:
                T.showShort(getActivity(),"干货分享");
                break;
            case 1:
                T.showShort(getActivity(),"灵感贩卖");
                break;
            case 2:
                T.showShort(getActivity(),"认领中心");
                break;
            case 3:
                break;
        }
