...
public class RelationMapRadioGroup extends RadioGroup {
    public RelationMapRadioGroup(Context context) {
        this(context, null);
    }

    public RelationMapRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
