...
public class FeedForCommentListAdapter$ShareCommentListAdapterViewHolder_ViewBinding implements Unbinder {
  private FeedForCommentListAdapter.ShareCommentListAdapterViewHolder target;

  @UiThread
  public FeedForCommentListAdapter$ShareCommentListAdapterViewHolder_ViewBinding(FeedForCommentListAdapter.ShareCommentListAdapterViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FeedForCommentListAdapter.ShareCommentListAdapterViewHolder target = this.target;
